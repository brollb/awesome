...
globalkeys = awful.util.table.join(
    ...
    --awful.key({ modkey, "Alt"}, "j",   awful.tag.viewprev,
              --{description = "view previous", group = "tag"}),
    --awful.key({ modkey, "Alt"}, "k",  awful.tag.viewnext,
    ...
    awful.key({ modkey,           }, "Return",
        function ()
            ...
            cpid = os.capture('pgrep -P ' .. pid)
            cwd = os.capture('readlink /proc/'..cpid..'/cwd')
            if string.len(cwd) > 0 then
              shell = os.capture('getent passwd $LOGNAME | cut -d: -f7')
              cmd = terminal .. ' -e "cd ' .. cwd .. ' && ' .. shell .. '"'
    ...
    awful.key({ }, "Menu", function () awful.spawn(terminal .. ' -e ranger') end,
              {description = "open ranger", group = "launcher"}),

    awful.key({modkey }, "Menu", function () awful.spawn('cerebro') end,
              {description = "open cerebro", group = "launcher"}),
